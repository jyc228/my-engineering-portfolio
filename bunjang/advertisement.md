...
광고 미송출 20%를 자발적으로 발견하고 개선 프로젝트를 직접 기획 · 리드 → 일 100만원 추가 수익 창출, 타임아웃 비중 5% 이하로 개선
...
이 프로젝트를 통해 저는 기술적 문제 해결을 넘어, 비즈니스 지표를 직접 개선하고 동료의 성장을 도우며 팀의 성과를 함께 만들어 갈 수 있는 엔지니어 임을 보여줬습니다.